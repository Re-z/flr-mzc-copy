...
//             if (globalCurrency == "$" && val.code == "USD") {
//                 btcrate = val.rate;
//                 $(".btc-rise").html("$" + btcrate);
//                 return false;
//             }
//             if (globalCurrency == "€" && val.code == "EUR") {
//                 btcrate = val.rate;
//                 $(".btc-rise").html(btcrate + "€");
//                 return false;
//             }
...
function todayDate() {
    ...
    $(".btc-date").html(output);
};

function cookieBar() {
    $.cookieBar('addTranslation', 'en', {
        message: 'We use cookies to understand how you use our site and to improve your experience. This includes personalizing content and advertising. By continuing to use our site, you accept our use of cookies, revised Privacy Policy and Terms of Use. This website is an Advertorial.',
        acceptText: 'OK',
    ...
    $.cookieBar({
        style: 'bottom',
        expireDays: 1,
        infoLink: 'legal/terms.html'
    });
};

function chartSlider() {
    var cryptologos = $("#cryptoCoins .coins-logos img");
    $("#chartSlider").carousel({
        interval: 5000,
        pause: false,
        wrap: true
    });
    $("#chartSlider").on('slide.bs.carousel', function() {
        var displayedIndex = $(this).find('.active').index();
        $(cryptologos[displayedIndex]).removeClass("coin-active");
    });
    $("#chartSlider").on('slid.bs.carousel', function() {
        var displayedIndex = $(this).find('.active').index();
        $(cryptologos).removeClass("coin-active");
        $(cryptologos[displayedIndex]).addClass("coin-active");
    });
    $(cryptologos).on('click', function() {
        $("#chartSlider").carousel($(cryptologos).index(this));
    });
}
$(document).ready(function() {
    // getbtcrates();
    // setInterval(getbtcrates, 10000);
    todayDate();
    cookieBar();
    chartSlider();
    $('.assetsWrap').marquee({
